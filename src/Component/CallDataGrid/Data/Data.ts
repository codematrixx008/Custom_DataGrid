...
export const listViewColumns = [
    ...
    { ColumnHeader: "BirthDate", DataType: "date", Tooltip: false, Width: 200, isVisible: true, isEditable: false, isFreeze: false, Sorting: true, Filtering: true, ColumnOrder: 2 },
    ...
    { ColumnHeader: "StartDate", DataType: "date", Tooltip: false, Width: 200, isVisible: true, isEditable: false, isFreeze: false, Sorting: true, Filtering: true, ColumnOrder: 6 },
