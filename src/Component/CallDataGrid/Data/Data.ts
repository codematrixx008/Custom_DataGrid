...
export const listViewColumns = [
    ...
    { ColumnHeader: "StartDate", DataType: "date", Tooltip: false, Width: 150, isVisible: true, isEditable: true, isFreeze: false, Sorting: true, Filtering: true, ColumnOrder: 6, Alignment: "center" },
